...
_images = VFSClass().join(xbmcaddon.Addon('script.module.dudehere.routines').getAddonInfo('path'), 'resources/textures/default')
...
class Edit(xbmcgui.ControlEdit):
    ...
    *Note, You can use the above as keywords for arguments and skip certain optional arguments.
    ...
    """
    def __new__(cls, *args, **kwargs):
        textures = {'focusTexture': os.path.join(_images, 'Edit', 'button-focus2.png'),
