...
class Generator:
    ...
    def __init__(self):
        ...
        self.tools_path = os.path.abspath(os.path.join(os.path.dirname(
    ...
    def _generate_repo_files(self):
        ...
        repo_xml = template_xml.format(addonid=addonid,
                                       name=name,
                                       version=version,
                                       author=author,
                                       summary=summary,
        ...
        self._save_file(
            repo_xml.encode("utf-8"),
            file=addonid + os.path.sep + "addon.xml")
    ...
    def _generate_addons_file(self):
        ...
        self._save_file(
            ...
            file=self.output_path + "addons.xml")

    def _generate_md5_file(self):
        try:
            # create a new md5 hash
            m = md5.new(open(self.output_path + "addons.xml").read(
            )).hexdigest()
            # save file
