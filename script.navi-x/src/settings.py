...
if   core_homepage=="default":          home_URL=home_URL_havana  #pass
elif core_homepage=="havana":           home_URL=home_URL_havana
elif core_homepage=="havana2":          home_URL=home_URL_havana_old
elif core_homepage=="offshore":         home_URL=home_URL_offshore; home_URL_old=home_URL_havana
...
try: url_open_timeout=int(SettingG("urltimeout","20"))
except: url_open_timeout=20 #60 seconds
try: page_size=int(SettingG("pagesize","200"))
except: page_size=200 #display maximum 200 entries on one page
try: history_size=int(SettingG("historysize","50"))
except: history_size=50 #maximum of entries in the history list
...
if   skinsColor=='Default': skinsColor=DefaultOutputColor #skinsColorDefault
elif skinsColor=='[COLOR ff00ff00]Green[/COLOR]': skinsColor='ff00ff00'; 
elif skinsColor=='[COLOR ff0000ff]Blue[/COLOR]': skinsColor='ff0000ff'; 
elif skinsColor=='[COLOR ffff0000]Red[/COLOR]': skinsColor='ffff0000'; 
elif skinsColor=='[COLOR ff800080]Purple[/COLOR]': skinsColor='ff800080'; 
elif skinsColor=='[COLOR ffffa500]Orange[/COLOR]': skinsColor='ffffa500'; 
elif skinsColor=='[COLOR ffd2b48c]Tan[/COLOR]': skinsColor='ffd2b48c'; 
elif skinsColor=='[COLOR ff9370d8]Medium Purple[/COLOR]': skinsColor='ff9370d8'; 
elif skinsColor=='[COLOR ffffc0cb]Pink[/COLOR]': skinsColor='ffffc0cb'; 
elif skinsColor=='[COLOR ffff1493]Deep Pink[/COLOR]': skinsColor='ffff1493'; 
elif skinsColor=='[COLOR ffdeb887]Burly Wood[/COLOR]': skinsColor='ffdeb887'; skinsColor2='FF000000'
elif skinsColor=='[COLOR ffff7f50]Coral[/COLOR]': skinsColor='ffff7f50'; 
elif skinsColor=='[COLOR ff6495ed]Corn Flower Blue[/COLOR]': skinsColor='ff6495ed'; 
elif skinsColor=='[COLOR ffdc143c]Crimson[/COLOR]': skinsColor='ffdc143c'; 
elif skinsColor=='[COLOR ff8a2be2]Blue Violet[/COLOR]': skinsColor='ff8a2be2'; 
elif skinsColor=='[COLOR fffaebd7]Antique White[/COLOR]': skinsColor='fffaebd7'; 
elif skinsColor=='[COLOR ff696969]Dim Gray[/COLOR]': skinsColor='ff696969'; skinsColor2='FFFFFFFF'
elif skinsColor=='[COLOR ffb22222]Fire Brick[/COLOR]': skinsColor='ffb22222'; 
elif skinsColor=='[COLOR ff800000]Maroon[/COLOR]': skinsColor='ff800000'; skinsColor2='FFFFFFFF'
elif skinsColor=='[COLOR ffe6e6fa]Lavender[/COLOR]': skinsColor='ffe6e6fa'; 
elif skinsColor=='[COLOR ffffd700]Gold[/COLOR]': skinsColor='ffffd700'; 
elif skinsColor=='[COLOR ffffff00]yellow[/COLOR]': skinsColor='ffffff00'; 
elif skinsColor=='[COLOR fff5deb3]Wheat[/COLOR]': skinsColor='fff5deb3'; 

elif skinsColor=='[COLOR ff228b22]Forest Green[/COLOR]': skinsColor='ff228b22'; 
elif skinsColor=='[COLOR ffff00ff]Fuchsia[/COLOR]': skinsColor='ffff00ff'; 
elif skinsColor=='[COLOR ffadff2f]Green Yellow[/COLOR]': skinsColor='ffadff2f'; 
elif skinsColor=='[COLOR fff0fff0]Honey Dew[/COLOR]': skinsColor='fff0fff0'; 
elif skinsColor=='[COLOR ffff69b4]Hot Pink[/COLOR]': skinsColor='ffff69b4'; 
elif skinsColor=='[COLOR ffcd5c5c]Indian Red[/COLOR]': skinsColor='ffcd5c5c'; 
elif skinsColor=='[COLOR ff4b0082]Indigo[/COLOR]': skinsColor='ff4b0082'; 
elif skinsColor=='[COLOR fffff0f5]Lavender Blush[/COLOR]': skinsColor='fffff0f5'; 
elif skinsColor=='[COLOR ff7cfc00]Lawn Green[/COLOR]': skinsColor='ff7cfc00'; 
elif skinsColor=='[COLOR fffffacd]Lemon Chiffon[/COLOR]': skinsColor='fffffacd'; 
elif skinsColor=='[COLOR fff08080]Light Coral[/COLOR]': skinsColor='fff08080'; 
elif skinsColor=='[COLOR ffe0ffff]Light Cyan[/COLOR]': skinsColor='ffe0ffff'; 
elif skinsColor=='[COLOR fffafad2]Light Golden Rod Yellow[/COLOR]': skinsColor='fffafad2'; 
elif skinsColor=='[COLOR ff87cefa]Light Sky Blue[/COLOR]': skinsColor='ff87cefa'; 
elif skinsColor=='[COLOR fffaf0e6]Linen[/COLOR]': skinsColor='fffaf0e6'; 
elif skinsColor=='[COLOR ff32cd32]Lime Green[/COLOR]': skinsColor='ff32cd32'; 
elif skinsColor=='[COLOR ff00fa9a]Medium Spring Green[/COLOR]': skinsColor='ff00fa9a'; 
elif skinsColor=='[COLOR ffda70d6]Orchid[/COLOR]': skinsColor='ffda70d6'; 
elif skinsColor=='[COLOR ffd87093]Pale Violet Red[/COLOR]': skinsColor='ffd87093'; 
elif skinsColor=='[COLOR ffffefd5]Papaya Whip[/COLOR]': skinsColor='ffffefd5'; 
elif skinsColor=='[COLOR ffb0e0e6]Powder Blue[/COLOR]': skinsColor='ffb0e0e6'; 
elif skinsColor=='[COLOR ffdda0dd]Plum[/COLOR]': skinsColor='ffdda0dd'; 
elif skinsColor=='[COLOR ffcd853f]Peru[/COLOR]': skinsColor='ffcd853f'; 
elif skinsColor=='[COLOR ffffdab9]Peach Puff[/COLOR]': skinsColor='ffffdab9'; 
elif skinsColor=='[COLOR ffbc8f8f]Rosy Brown[/COLOR]': skinsColor='ffbc8f8f'; 
elif skinsColor=='[COLOR ff4169e1]Royal Blue[/COLOR]': skinsColor='ff4169e1'; 
elif skinsColor=='[COLOR ff8b4513]Saddle Brown[/COLOR]': skinsColor='ff8b4513'; 
elif skinsColor=='[COLOR fffa8072]Salmon[/COLOR]': skinsColor='fffa8072'; 
elif skinsColor=='[COLOR fff4a460]Sandy Brown[/COLOR]': skinsColor='fff4a460'; 
elif skinsColor=='[COLOR fffff5ee]Sea Shell[/COLOR]': skinsColor='fffff5ee'; 
elif skinsColor=='[COLOR ffa0522d]Sienna[/COLOR]': skinsColor='ffa0522d'; 
elif skinsColor=='[COLOR ff87ceeb]Sky Blue[/COLOR]': skinsColor='ff87ceeb'; 
elif skinsColor=='[COLOR ff6a5acd]Slate Blue[/COLOR]': skinsColor='ff6a5acd'; 
elif skinsColor=='[COLOR ff708090]Slate Gray[/COLOR]': skinsColor='ff708090'; 
elif skinsColor=='[COLOR fffffafa]Snow[/COLOR]': skinsColor='fffffafa'; 
elif skinsColor=='[COLOR ff00ff7f]Spring Green[/COLOR]': skinsColor='ff00ff7f'; 
elif skinsColor=='[COLOR ff4682b4]Steel Blue[/COLOR]': skinsColor='ff4682b4'; 
elif skinsColor=='[COLOR ff008080]Teal[/COLOR]': skinsColor='ff008080'; 
elif skinsColor=='[COLOR ffd8bfd8]Thistle[/COLOR]': skinsColor='ffd8bfd8'; 
elif skinsColor=='[COLOR ffff6347]Tomato[/COLOR]': skinsColor='ffff6347'; 
elif skinsColor=='[COLOR ff40e0d0]Turquoise[/COLOR]': skinsColor='ff40e0d0'; 
elif skinsColor=='[COLOR ffee82ee]Violet[/COLOR]': skinsColor='ffee82ee'; 
elif skinsColor=='[COLOR ffffffff]White[/COLOR]': skinsColor='ffffffff'; skinsColor2='FF000000'
elif skinsColor=='[COLOR fff5f5f5]White Smoke[/COLOR]': skinsColor='fff5f5f5'; skinsColor2='FF000000'
elif skinsColor=='[COLOR ff9acd32]Yellow Green[/COLOR]': skinsColor='ff9acd32'; 
#elif skinsColor=='[COLOR ][/COLOR]': skinsColor=''; 
#elif skinsColor=='[COLOR ][/COLOR]': skinsColor=''; 
#elif skinsColor=='[COLOR ][/COLOR]': skinsColor=''; 
else: skinsColor=DefaultOutputColor #skinsColorDefault
...
cachedFlag=False
cachedFlag = ''
try: DefaultCachedExpires=(int(SettingG('cachedexpires','2'))*60)*60
except: DefaultCachedExpires=7200
CachedPagesAndTimes=[]
...
CachedPagesAndTimes.append([72,nxserver_URL.lower()+'/playlist/50242/navi-xtreme_nxportal_home.plx'])   # Navi-X Portal
